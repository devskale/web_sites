...
import { ARLIAI_TOKEN } from "./config.js";
...
export async function sendArliOpenAIRequest(
  url,
  model,
  input,
  responseDiv,
  ...
  try {
    const response = await fetch(url, {
      ...
      headers: {
        ...
        Authorization: `Bearer ${ARLIAI_TOKEN}`,
      },
    ...
    console.error("Error in sendArliOpenAIRequest:", error);
